...
( function( global, factory ) {
  ...
  // 新增 by zwl 2018.10.17
  var ckplayerJS = '/assets/libs/js/video/ckplayer/ckplayer.js';
  var ckplayerSWF =  '/assets/libs/js/video/ckplayer/ckplayer.swf';
  var m3u8SWF =   '/assets/libs/js/video/ckplayer/m3u8.swf';
  var hlsJS ='/assets/libs/js/video/hls.min.js';
  ...
  EZUIPlayer.prototype.play = function(){
    ...
    if(!!window['CKobject']){
      if(CKobject.getObjectById(this.flashId)){
