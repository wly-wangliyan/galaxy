...
export class ParkingStatisticsComponent implements OnInit {
  ...
  public idSearchData: boolean = true;
  public regionList = [
    {
      name: '和平区', code: '210102', isChecked: false
    },
    {
      name: '沈河区', code: '210103', isChecked: false
    },
    {
      name: '浑南区', code: '210112', isChecked: false
    },
    {
      name: '皇姑区', code: '210105', isChecked: false
    },
    {
      name: '沈北新区', code: '210113', isChecked: false
    },
    {
      name: '苏家屯区', code: '210111', isChecked: false
    },
    {
      name: '铁西区', code: '210106', isChecked: false
    },
    {
      name: '于洪区', code: '210114', isChecked: false
    },
  ];
  ...
  @ViewChild('entryFlowByHour') public entryFlowByHourCpt: ParkingFlowByhourComponent;
  @ViewChild('exitFlowByHour') public exitFlowByHourCpt: ParkingFlowByhourComponent;
  ...
  // 删除历史
  public onDeleteHistoryClick(item: ParkingHistoryEntity) {
  ...
  // 点击查看历史每一条数据 右侧显示
  public onLookHistoryDetailClick(event) {
    this.onSelectTableItem(event, 1);
  }

  // 日流量统计select  event 0日 1周 2月
  public onFlowSelectChange(event) {
  ...
  // 周转率统计select
  public onTurnoverSelectChange(event) {
