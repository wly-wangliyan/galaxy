...
export class DSFlowHttpService {
  ...
  public requestParkingStatisticsExitFlowByHourList(region_id: string, startDate: Date, endDate: Date, parking_id: string): Observable<Array<ParkingExitFlowByHourEntity>> {
    ...
    return this.httpService.get(this.domain + '/parking_statistics/parking_exit_flow_by_hour', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
  ...
  public requestParkingStatisticsEntryFlowByDayList(region_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/parking_statistics/parking_entry_flow_by_day', params).map(data => new ParkingEntryFlowByDayLinkResponse(data));
  }
  ...
  public continueParkingStatisticsEntryFlowByDayList(url: string): Observable<ParkingEntryFlowByDayLinkResponse> {
    return this.httpService.get(url).map(data => new ParkingEntryFlowByDayLinkResponse(data));
  }
   ...
   * @returns {Observable<R>}
   */
  public requestParkingStatisticsEntryFlowByWeekList(parking_id: string, order_by: string , region_id: string, startDate: Date, endDate: Date, page_size: number = 1000): Observable<Array<ParkingEntryFlowByWeekEntity>> {
    const section = DateFormatHelper.GenerateSection(startDate, endDate);
    const params = this.httpService.generateURLSearchParams({
      parking_id: parking_id,
      order_by: order_by,
    ...
    return this.httpService.get(this.domain + '/parking_statistics/parking_entry_flow_by_week', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
   ...
   * @returns {Observable<R>}
   */
  public requestParkingStatisticsExitFlowByWeekList(parking_id: string, order_by: string , region_id: string, startDate: Date, endDate: Date, page_size: number = 1000): Observable<Array<ParkingEntryFlowByWeekEntity>> {
    const section = DateFormatHelper.GenerateSection(startDate, endDate);
    const params = this.httpService.generateURLSearchParams({
      parking_id: parking_id,
      order_by: order_by,
    ...
    return this.httpService.get(this.domain + '/parking_statistics/parking_exit_flow_by_week', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
        tempList.push(ParkingEntryFlowByWeekEntity.Create(jsonObj));
      });
  ...
  public requestParkingStatisticsEntryFlowByMonthList(parking_id: string, region_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/parking_statistics/parking_entry_flow_by_month', params).map(data => new ParkingEntryFlowByMonthLinkResponse(data));
  }
  ...
  public continueParkingStatisticsEntryFlowByMonthList(url: string): Observable<ParkingEntryFlowByMonthLinkResponse> {
    return this.httpService.get(url).map(data => new ParkingEntryFlowByMonthLinkResponse(data));
  }
  ...
  public requestParkingStatisticsEntryFlowByYearList(region_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/parking_statistics/parking_entry_flow_by_year', params).map(data => new ParkingEntryFlowByYearLinkResponse(data));
  }
  ...
  public continueParkingStatisticsEntryFlowByYearList(url: string): Observable<ParkingEntryFlowByYearLinkResponse> {
    return this.httpService.get(url).map(data => new ParkingEntryFlowByYearLinkResponse(data));
  }
  ...
  public requestRegionStatisticsEntryFlowByHourList(region_id: string, startDate: Date, endDate: Date, show_type: '1' | '2' = '1'): Observable<Array<RegionEntryFlowByHourEntity>> {
    ...
    return this.httpService.get(this.domain + '/region_statistics/parking_entry_flow_by_hour', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
  ...
  public requestRealTodayEntryFlow(): Observable<TodayRealFlowEntity> {
    return this.httpService.get(`${this.domain}/region_statistics/today_total_entry_flow`).map(data => TodayRealFlowEntity.Create(data.json()));
  }
  ...
  public requestRegionStatisticsEntryFlowByDayList(region_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/region_statistics/parking_entry_flow_by_day', params).map(data => new RegionEntryFlowByDayLinkResponse(data));
  }
  ...
  public continueRegionStatisticsEntryFlowByDayList(url: string): Observable<RegionEntryFlowByDayLinkResponse> {
    return this.httpService.get(url).map(data => new RegionEntryFlowByDayLinkResponse(data));
  }
  ...
  public requestRegionStatisticsEntryFlowByWeekList(region_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/region_statistics/parking_entry_flow_by_week', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
  ...
  public requestRegionStatisticsEntryFlowByMonthList(region_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/region_statistics/parking_entry_flow_by_month', params).map(data => new RegionEntryFlowByMonthLinkResponse(data));
  }
  ...
  public continueRegionStatisticsEntryFlowByMonthList(url: string): Observable<RegionEntryFlowByMonthLinkResponse> {
    return this.httpService.get(url).map(data => new RegionEntryFlowByMonthLinkResponse(data));
  }
  ...
  public requestRegionStatisticsEntryFlowByYearList(region_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/region_statistics/parking_entry_flow_by_year', params).map(data => new RegionEntryFlowByYearLinkResponse(data));
  }
  ...
  public continueRegionStatisticsEntryFlowByYearList(url: string): Observable<RegionEntryFlowByYearLinkResponse> {
    return this.httpService.get(url).map(data => new RegionEntryFlowByYearLinkResponse(data));
  }
  ...
  public requestGroupStatisticsEntryFlowByHourList(parking_group_id: string, startDate: Date, endDate: Date): Observable<Array<GroupEntryFlowByHourEntity>> {
    ...
    return this.httpService.get(this.domain + '/group_statistics/parking_entry_flow_by_hour', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
  ...
  public requestGroupStatisticsEntryFlowByDayList(parking_group_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/group_statistics/parking_entry_flow_by_day', params).map(data => new GroupEntryFlowByDayLinkResponse(data));
  }
  ...
  public continueGroupStatisticsEntryFlowByDayList(url: string): Observable<GroupEntryFlowByDayLinkResponse> {
    return this.httpService.get(url).map(data => new GroupEntryFlowByDayLinkResponse(data));
  }
  ...
  public requestGroupStatisticsEntryFlowByWeekList(parking_group_id: string, startDate: Date, endDate: Date, page_size: number = 1000): Observable<Array<GroupEntryFlowByWeekEntity>> {
    ...
    return this.httpService.get(this.domain + '/group_statistics/parking_entry_flow_by_week', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
  ...
  public requestGroupStatisticsEntryFlowByMonthList(parking_group_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/group_statistics/parking_entry_flow_by_month', params).map(data => new GroupEntryFlowByMonthLinkResponse(data));
  }
  ...
  public continueGroupStatisticsEntryFlowByMonthList(url: string): Observable<GroupEntryFlowByMonthLinkResponse> {
    return this.httpService.get(url).map(data => new GroupEntryFlowByMonthLinkResponse(data));
  }
  ...
  public requestGroupStatisticsEntryFlowByYearList(parking_group_id: string, startDate: Date,
    ...
    return this.httpService.get(this.domain + '/group_statistics/parking_entry_flow_by_year', params).map(data => new GroupEntryFlowByYearLinkResponse(data));
  }
  ...
  public continueGroupStatisticsEntryFlowByYearList(url: string): Observable<GroupEntryFlowByYearLinkResponse> {
    return this.httpService.get(url).map(data => new GroupEntryFlowByYearLinkResponse(data));
  }
  ...
  public requestParkingStatisticsTotalEntryFlowByDayList(startDate: Date, endDate: Date, page_size: number = 1000): Observable<Array<ParkingTotalEntryFlowByEveryDayEntity>> {
    ...
    return this.httpService.get(this.domain + '/parking_statistics/parking_entry_flow_by_everyday', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
  ...
  public requestGroupStatisticsTotalEntryFlowByDayList(startDate: Date, endDate: Date, page_size: number = 1000): Observable<Array<GroupTotalEntryFlowByEveryDayEntity>> {
    ...
    return this.httpService.get(this.domain + '/group_statistics/parking_entry_flow_by_everyday', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
   ...
   * @returns {Observable<R>}
   */
  public requestRegionStatisticsTotalEntryFlowByDayList(region_id: string, startDate: Date, endDate: Date, show_type: '1' | '2' = '1', page_size: number = 1000): Observable<Array<RegionTotalEntryFlowByEveryDayEntity>> {
    const section = DateFormatHelper.GenerateSection(startDate, endDate);
    const params = this.httpService.generateURLSearchParams({
      section: section,
      region_id: region_id,
    ...
    return this.httpService.get(this.domain + '/region_statistics/parking_entry_flow_by_everyday', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
  ...
  public requestRegionStatisticsExitFlowByHourList(region_id: string, startDate: Date, endDate: Date, page_size: number = 1000): Observable<Array<RegionExitFlowByHourEntity>> {
    ...
    return this.httpService.get(this.domain + '/region_statistics/parking_exit_flow_by_hour', params).map(data => {
      const tempList = [];
      data.json().forEach(jsonObj => {
  ...
  public requestTotalRegionStatisticsEntryFlow(): Observable<TotalEntryFlowEntity> {
    return this.httpService.get(this.domain + '/region_statistics/total_entry_flow').map(
      data => TotalEntryFlowEntity.Create(data.json()));
  }
}
