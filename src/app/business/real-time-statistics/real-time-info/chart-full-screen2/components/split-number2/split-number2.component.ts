...
import {SplitNumberComponent} from '../../../components/split-number/split-number.component';
import {Subscription} from 'rxjs/Subscription';

@Component({
  selector: 'app-split-number2',
  templateUrl: './split-number2.component.html',
  styleUrls: ['./split-number2.component.less']
})
export class SplitNumber2Component {
