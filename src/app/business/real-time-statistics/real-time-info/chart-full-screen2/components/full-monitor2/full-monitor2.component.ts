...
@Component({
  selector: 'app-full-monitor2',
  templateUrl: './full-monitor2.component.html',
  styleUrls: ['./full-monitor2.component.css']
})
export class FullMonitor2Component implements OnInit, AfterViewInit, OnDestroy {
