...
@Component({
  selector: 'app-full-progressbar',
  templateUrl: './full-progressbar.component.html',
  styleUrls: ['./full-progressbar.component.less']
})
export class FullProgressbarComponent {
