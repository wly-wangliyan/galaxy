...
@Component({
  selector: 'app-chat-scroll-number',
  templateUrl: './chat-scroll-number.component.html',
  styleUrls: ['./chat-scroll-number.component.css'],
  animations: [
...
export class ChatScrollNumberComponent {
